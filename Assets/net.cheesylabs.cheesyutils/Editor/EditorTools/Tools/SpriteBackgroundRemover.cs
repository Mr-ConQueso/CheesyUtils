...
namespace CheesyUtils.EditorTools
{
    public class SpriteBackgroundRemover : EditorWindow
    {
        ...
        private Texture2D _newImg;
        private Color _colorToRemove = Color.magenta;
        ...
        public static void CheckTextureSettings(Texture2D texture)
        {
            ...
            if (textureImporter.isReadable || !textureImporter) return;
