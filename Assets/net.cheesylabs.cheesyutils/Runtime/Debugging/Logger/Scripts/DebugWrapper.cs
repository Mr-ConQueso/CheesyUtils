...
namespace CheesyUtils
{
    ...
    public static class Debug
    {
        ...
        public static void Log(object message, Object context, DLogType type = DLogType.Log)
        {
            UnityEngine.Debug.Log("[" + type + "] " + message, context);
        }

        public static void LogFormat(string format, DLogType type = DLogType.Log, params object[] args)
        {
            UnityEngine.Debug.LogFormat("[" + type + "] " + format, args);
        }
        ...
        public static void LogWarning(object message, DLogType type = DLogType.Warning)
        {
